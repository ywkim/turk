...
Translate and annotate user expressions via Mechanical Turk
...
You can configure some of behavior using environment variables and config files.

### Environment Variable

| Config Value     | Description                                          |
|------------------|------------------------------------------------------|
| `MTURK_ENDPOINT` | e.g. https://mturk-requester.us-east-1.amazonaws.com |
| `MTURK_PREVIEW`  | e.g. https://www.mturk.com/mturk/preview             |
| `MTURK_MANAGE`   | e.g. https://requester.mturk.com/mturk/manageHITs    |
